/*
 * board_f1c100s.c - F1C100S board configuration
 *
...
sunxi_spi_t sunxi_spi0 = {
	...
	.gpio_miso = {GPIO_PIN(PORTC, 0), GPIO_PERIPH_MUX2},
	.gpio_sck  = {GPIO_PIN(PORTC, 1), GPIO_PERIPH_MUX2},
	.gpio_cs   = {GPIO_PIN(PORTC, 2), GPIO_PERIPH_MUX2},
	.gpio_mosi = {GPIO_PIN(PORTC, 3), GPIO_PERIPH_MUX2},
	.gpio_wp   = {0},
	.gpio_hold = {0},
};
...
static gpio_t led_blue = GPIO_PIN(PORTE, 5);
